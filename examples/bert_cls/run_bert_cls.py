...
from utils_bert_cls import read_examples_from_file, convert_examples_to_features, get_labels, compute_metrics
...
def main():
    ...
    parser.add_argument(
        ...
        help="Should be either classification or regression.")
    parser.add_argument(
        "--labels",
        required=True,
        type=str,

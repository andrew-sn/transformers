...
class BertClsForSequenceClassification(BertPreTrainedModel):
    def __init__(self, config):
        super().__init__(config)
    ...
    Examples::
        ...
        if self.multi_label:  # 因为在multi-label任务中使用MultiLabelSoftMarginLoss，其本质上是对每个标签做使用对数几率回归的方式计算loss，因此这里要使用sigmoid激活
